...
class LENSREADERANALOGUELIVELINK_API FLensReaderAnalogueLiveLinkSource : public ILiveLinkSource, public FRunnable
{
public:

	FLensReaderAnalogueLiveLinkSource(FText Endpoint);

	virtual ~FLensReaderAnalogueLiveLinkSource();
